...
object Interaction2 {
  ...
  val MIN_YEAR = 1975
  val MAX_YEAR = 2016
  val DEVIATION_MIN_YEAR = 1990
  val DEVIATION_MAX_YEAR = 2016
  ...
  def availableLayers: Seq[Layer] = {
    List(
      Layer(LayerName.Temperatures, Palettes.temperatures, Range(MIN_YEAR, MAX_YEAR)),
      Layer(LayerName.Deviations, Palettes.deviations, Range(DEVIATION_MIN_YEAR, DEVIATION_MAX_YEAR)))
  }
