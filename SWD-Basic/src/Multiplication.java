public class Multiplication {
	...
	public int mult_Jimmy(int a, int b)
	{
		...
		//Logic to validate if the variable "a" is negative, when case is true it change its natural state to positive.
		if (a < 0) 
		{
			a = a*-1; 
			signFlag = -1; 
		...
		//Logic to validate if the variable "a" is pair, when case is true the variable "result" is set with the "b" value.
		if(a%2 == 0) 
		{
			result = 0;
		}else{
